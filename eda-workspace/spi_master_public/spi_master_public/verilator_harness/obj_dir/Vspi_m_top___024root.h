...
#ifndef VERILATED_VSPI_M_TOP___024ROOT_H_
#define VERILATED_VSPI_M_TOP___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vspi_m_top___024root final : public VerilatedModule {
  public:
    // CELLS
    Vspi_m_top_spi_m_top* spi_m_top;
    ...
    struct {
        ...
        CData/*0:0*/ __Vtrigprevexpr___TOP__spi_m_top__clk__0;
        CData/*0:0*/ __Vtrigprevexpr___TOP__spi_m_top__rst_n__0;
    ...
    // CONSTRUCTORS
    Vspi_m_top___024root(Vspi_m_top__Syms* symsp, const char* v__name);
    ~Vspi_m_top___024root();
    VL_UNCOPYABLE(Vspi_m_top___024root);
