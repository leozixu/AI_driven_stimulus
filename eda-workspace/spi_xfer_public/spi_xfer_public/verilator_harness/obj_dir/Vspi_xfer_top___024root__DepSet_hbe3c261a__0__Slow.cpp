...
VL_ATTR_COLD void Vspi_xfer_top___024root___eval_static(Vspi_xfer_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vspi_xfer_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vspi_xfer_top___024root___eval_static\n"); );
}

VL_ATTR_COLD void Vspi_xfer_top___024root___eval_final(Vspi_xfer_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vspi_xfer_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vspi_xfer_top___024root___eval_final\n"); );
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vspi_xfer_top___024root___dump_triggers__stl(Vspi_xfer_top___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vspi_xfer_top___024root___eval_phase__stl(Vspi_xfer_top___024root* vlSelf);

VL_ATTR_COLD void Vspi_xfer_top___024root___eval_settle(Vspi_xfer_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vspi_xfer_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vspi_xfer_top___024root___eval_settle\n"); );
    // Init
...
#endif
            VL_FATAL_MT("/workspace/spi_xfer_public/spi_xfer_public/verilator_harness/../dut/spi_xfer_top.v", 10, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vspi_xfer_top___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vspi_xfer_top___024root___dump_triggers__stl(Vspi_xfer_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vspi_xfer_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vspi_xfer_top___024root___dump_triggers__stl\n"); );
    // Body
...
VL_ATTR_COLD bool Vspi_xfer_top___024root___eval_phase__stl(Vspi_xfer_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vspi_xfer_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vspi_xfer_top___024root___eval_phase__stl\n"); );
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vspi_xfer_top___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelf->__VstlTriggered.any();
    if (__VstlExecute) {
        Vspi_xfer_top___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vspi_xfer_top___024root___dump_triggers__ico(Vspi_xfer_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vspi_xfer_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vspi_xfer_top___024root___dump_triggers__ico\n"); );
    // Body
...
VL_ATTR_COLD void Vspi_xfer_top___024root___dump_triggers__act(Vspi_xfer_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vspi_xfer_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vspi_xfer_top___024root___dump_triggers__act\n"); );
    // Body
    if ((1U & (~ (IData)(vlSelf->__VactTriggered.any())))) {
        VL_DBG_MSGF("         No triggers active\n");
    }
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge spi_xfer_top.clk or negedge spi_xfer_top.rst_n)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vspi_xfer_top___024root___dump_triggers__nba(Vspi_xfer_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vspi_xfer_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vspi_xfer_top___024root___dump_triggers__nba\n"); );
    // Body
    if ((1U & (~ (IData)(vlSelf->__VnbaTriggered.any())))) {
        VL_DBG_MSGF("         No triggers active\n");
    }
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge spi_xfer_top.clk or negedge spi_xfer_top.rst_n)\n");
    }
}
#endif  // VL_DEBUG

VL_ATTR_COLD void Vspi_xfer_top___024root___ctor_var_reset(Vspi_xfer_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vspi_xfer_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vspi_xfer_top___024root___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__Vtrigprevexpr___TOP__spi_xfer_top__clk__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__spi_xfer_top__rst_n__0 = VL_RAND_RESET_I(1);
}
