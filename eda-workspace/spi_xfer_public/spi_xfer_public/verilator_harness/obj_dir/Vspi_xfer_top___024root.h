...
#ifndef VERILATED_VSPI_XFER_TOP___024ROOT_H_
#define VERILATED_VSPI_XFER_TOP___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vspi_xfer_top___024root final : public VerilatedModule {
  public:
    // CELLS
    Vspi_xfer_top_spi_xfer_top* spi_xfer_top;
    ...
    CData/*0:0*/ __Vtrigprevexpr___TOP__spi_xfer_top__clk__0;
    CData/*0:0*/ __Vtrigprevexpr___TOP__spi_xfer_top__rst_n__0;
    ...
    // CONSTRUCTORS
    Vspi_xfer_top___024root(Vspi_xfer_top__Syms* symsp, const char* v__name);
    ~Vspi_xfer_top___024root();
    VL_UNCOPYABLE(Vspi_xfer_top___024root);
